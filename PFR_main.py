...
from utils.time_util import get_exchange_code, is_closing_minute, is_opening_minute,set_initial_checked_minute,get_session_end_time
...
def initialize_components(now):
    ...
    set_initial_checked_minute(price_handler, now)
